...
$result = $mysqli->query($sql);
$sql = "CREATE TABLE NEC_ORDER (ID BIGINT NOT NULL auto_increment, USERNAME VARCHAR(255), STOCK_ID BIGINT, STOCK_NAME VARCHAR(255), QUANTITY INTEGER, REMARK TEXT, PRIMARY KEY (ID), FOREIGN KEY (USERNAME) REFERENCES NEC_USER (USERNAME), FOREIGN KEY (STOCK_ID) REFERENCES STOCK (ID))";
$result = $mysqli->query($sql);
